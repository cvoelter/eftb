...
####Plotting box preferences in ED phase
...
```{r shelf_setup, fig.cap="Shifting task with boxes from updating study and filling material as predictive cue.", echo=FALSE}
