...
for(i in 1:100000){
  ...
  while(trial.count<8 & length(unique(res1))<crit.thresh  & ((trial.count1-length(unique(res1)))+(trial.count2-length(unique(res2))))<6){
    if(trial.count<8 & length(unique(res1))<crit.thresh & ((trial.count1-length(unique(res1)))+(trial.count2-length(unique(res2))))<6){
	      res1<-c(res1,sample(n.cups,size=1, replace=T))
	  		trial.count=trial.count+1 
	  		trial.count1=trial.count1+1 }
    if(trial.count<8 & length(unique(res2))<crit.thresh & ((trial.count1-length(unique(res1)))+(trial.count2-length(unique(res2))))<6){
	    res2<-c(res2,sample(n.cups,size=1, replace=T))
		  trial.count=trial.count+1
		  trial.count2=trial.count2+1 }
  }
...
for(i in 1:10000){
  ...
  res1=c()
  res2=c()
  while(trial.count<4 & length(unique(res1))<crit.thresh  & ((trial.count1-length(unique(res1)))+(trial.count2-length(unique(res2))))<6){
    if(trial.count<4 & length(unique(res1))<crit.thresh & ((trial.count1-length(unique(res1)))+(trial.count2-length(unique(res2))))<6){
	      res1<-c(res1,sample(n.cups,size=1, replace=T))
	  		trial.count=trial.count+1 
	  		trial.count1=trial.count1+1 }
    if(trial.count<4 & length(unique(res2))<crit.thresh & ((trial.count1-length(unique(res1)))+(trial.count2-length(unique(res2))))<6){
	    res2<-c(res2,sample(n.cups,size=1, replace=T))
		  trial.count=trial.count+1
		  trial.count2=trial.count2+1 }
  }
